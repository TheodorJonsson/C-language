...
*
* Firstly checks if the set is empty or not.
* If the set is empty prints out that it is and returns 0.
* It its not empty generates a random number from 0 to the max capacity.
* Does this until it finds a number that is apart of the set
* then returns it.
*
* 
*
